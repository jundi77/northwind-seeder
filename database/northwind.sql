...
ALTER TABLE ONLY employees
	ALTER COLUMN employee_id SET DEFAULT nextval(pg_get_serial_sequence('employees','employee_id')) + 1;
...
ALTER TABLE ONLY products
	ALTER COLUMN product_id SET DEFAULT nextval(pg_get_serial_sequence('products','product_id')) + 1;
...
ALTER TABLE ONLY shippers
	ALTER COLUMN shipper_id SET DEFAULT nextval(pg_get_serial_sequence('shippers','shipper_id')) + 1;
...
ALTER TABLE ONLY region
	ALTER COLUMN region_id SET DEFAULT nextval(pg_get_serial_sequence('region','region_id')) + 1;
...
ALTER TABLE ONLY suppliers
	ALTER COLUMN supplier_id SET DEFAULT nextval(pg_get_serial_sequence('suppliers','supplier_id')) + 1;
...
ALTER TABLE ONLY us_states
	ALTER COLUMN state_id SET DEFAULT nextval(pg_get_serial_sequence('us_states','state_id')) + 1;
...
ALTER TABLE ONLY orders
	ALTER COLUMN order_id SET DEFAULT nextval(pg_get_serial_sequence('orders','order_id')) + 1;
...
ALTER TABLE ONLY categories
	ALTER COLUMN category_id SET DEFAULT nextval(pg_get_serial_sequence('categories','category_id')) + 1;
